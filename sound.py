...
pygame.init()
_display_surf = pygame.display.set_mode(size, pygame.HWSURFACE
        | pygame.DOUBLEBUF)
...
for s in range(n_samples):
    ...
    buf[s][0] = int(round(max_sample * math.sin(2 * math.pi * nums[run]
                    * t)))  # left
    buf[s][1] = int(round(max_sample * 0.5 * math.sin(2 * math.pi
                    * nums[run] * t)))  # right
