...
class BuildExe:
    ...
    def run(self):
        ...
        extra_datas = [
            'empty.png',
            'pygameui\\resources\\images\\info.png',
            'pygameui\\resources\\images\\logo.png',
            'pygameui\\resources\\images\\shadow.png',
            'pygameui\\resources\\images\\spinner.png',
            'pygameui\\resources\\images\\star.png',
            ]
